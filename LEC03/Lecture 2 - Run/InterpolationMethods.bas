...
For yearFraction = yearBase To 365 * yearBase Step yearBase
    i = i + 1
    xHat(i) = yearFraction
    yHat(i) = nearestNeighbor(xHat(i), rates, maturities)
Next yearFraction
...
Private Function nearestNeighbor(targetMaturity As Double, rates() As Double, maturities() As Double) As Double
